...
clearvars -except V U BV D SM F1G RMSEgroup RMSEdecomp PAS POP type d colors
numIterations = 10;
...
elseif strcmp(designvars,'counts')
    F1G{2} = train_F1s ;
    figure(20);hold on;scatter(F1G{1}(:,1),F1G{2}(:,1),'filled','markerfacecolor',rgb(colors{d}));
