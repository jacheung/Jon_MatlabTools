...
%**************************************************************************
% SM=SM([1 3:10]);
close all; clearvars -except U D BV SM
%% Parameters
...
%% PLOTTING MEDIANSx
figure(376);hold on;scatter(ones(length(U),1).*2,distmed,'k','linewidth',8)
hold on; plot([-.5 2.5],[0 0], '-.ok')
set(gca,'ylim',[-20 20],'yaxislocation','right','xtick',[],'xlim',[-.5 2.5])
ylabel('Search Bias')
