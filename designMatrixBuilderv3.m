...
function [DmatX, DmatY, motorX] = designMatrixBuilderv3(V,U,designvars,classes,normalization,sampMethod,dropempty)
...
switch designvars
    ...
    case 'ubered'
        ...
        %         hx = [hxk' V.var.hit{10}(:,1) hxw   V.touchNum.hit' hxr(:,1) hx']; %10 is cue to touch
        %         FAx = [FAxk' V.var.FA{10}(:,1) FAxw V.touchNum.FA' FAxr(:,1)  FAx'   ];
        %         CRx = [CRxk'  V.var.CR{10}(:,1) CRxw  V.touchNum.CR' CRxr(:,1) CRx'];
...
switch dropempty
    case 'yes'
        ...
        if strcmp(designvars,'decompTime') || strcmp(designvars,'timeTotouch') ||strcmp(designvars,'onsetTheta') || strcmp(designvars,'uberedRadial') || strcmp(designvars,'velocity') || strcmp(designvars,'Ivelocity') || strcmp(designvars,'whiskOnset') || strcmp(designvars,'ubered')
