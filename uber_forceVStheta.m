...
figure(22);
errorbar(1:6,train_Acc{1},train_std{1},'bo')
...
set(gca,'xtick',[linspace(1,6,6)],'ylim',[25 100])
%%
params = 3;
FCratio = [];
for rec = 6
    ...
    switch params
        case 1
            ...
            ylabel('Probability');xlabel('Velocity')
        case 2
