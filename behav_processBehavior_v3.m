...
if isfield(info,'pole_contdiscrim_obj_hit_history')
...
elseif isfield(info,'pole_contdiscrim_axes_obj_hit_history')
    trialResults(:,10)=info.MotorsSection_previous_pole_positions(1:length(info.pole_contdiscrim_axes_obj_hit_history)); %fill 8 w/ motor positions
end
