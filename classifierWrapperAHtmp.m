...
function [V] = classifierWrapperAHtmp(uberarray)
...
%         
    ...
    V(rec).trialNums.matrix = zeros(3,array.k);
    V(rec).trialNums.matrix = array.trialTypeMat(1:2,:);
    V(rec).trialNums.matrix(3,:) = array.trialTypeMat(4,:);
    V(rec).trialNums.matrix(4,:) = array.trialTypeMat(3,:);
